...
public class FahrenheitCelsiusTest extends junit.framework.TestCase {
    ...
    public void test_negativefahrenheitEnCelsius() {
        assertEquals("  -100 °F -> -73.3 °C ? ", -73.3, question1.FahrenheitCelsius.fahrenheitEnCelsius(-100), 0.1);
        assertEquals(" -2000 °F -> -1128.8 °C ?", -1128.8, question1.FahrenheitCelsius.fahrenheitEnCelsius(-2000), 0.1);
        assertEquals("   -54 °F -> -47.7 °C ?", -47.7, question1.FahrenheitCelsius.fahrenheitEnCelsius(-54), 0.1);
    }
    ...
    public void test_RandomValuesfahrenheitEnCelsius() {
        ...
        assertEquals("  -1 °F -> -18.3 °C ? ", -18.3, question1.FahrenheitCelsius.fahrenheitEnCelsius(-1), 0.1);
        assertEquals(" 666 °F -> 352.2 °C ?", 352.2, question1.FahrenheitCelsius.fahrenheitEnCelsius(666), 0.1);
    }
}
